...
exports.run = (client, message, args) => {
    if(!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(new Discord.MessageEmbed().setTitle("Yetkin yok").setDescription("yetki lazım olm").setColor("RED").setFooter(message.author.tag, message.author.displayAvatarURL({dynamic: true})))
...
Bu komutu kullanırken bilmen gerekenler:
  ...
  <a:uyar:788054399208652840>Eğer **${prefix}${message.content.split(" ")[0].slice(ayarlar.prefix.length)}'**dan sonra <a:uyar:788054399208652840>
  **• Komutlar**
  <a:rar:790320024979505212> **${ekle.join(", ")}** = yazarsan yeni bir otocevap ekler.<a:hyper:788060823410704415>
  <a:rar:790320024979505212> **${sil.join(", ")}**  = yazarsan bir otocevabı siler.<a:hyper:788060823410704415>
  <a:rar:790320024979505212> **${list.join(", ")}** = yazarsan sunucudaki otocevapları listeler.<a:hyper:788060823410704415>
  <a:rar:790320024979505212> **${edit.join(", ")}** = yazarsan bir otocevabı editlersin.<a:hyper:788060823410704415>
...
`)
            .setColor("RANDOM")
            .setFooter(footer)
            .setImage("https://media.discordapp.net/attachments/721721144528338954/780742714476068875/standard_6.gif")
