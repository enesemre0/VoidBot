...
exports.run = async (receivedMessage,  msg, args) => {
  if (!msg.member.permissions.has("BAN_MEMBERS")) return msg.channel.send("<a:hayirgif:787990150331760641> Bu komudu kullanabilmek için `Üyeleri Yasakla` yetkisine sahip olman gerek.");
...
var reason = args[1]
 ...
 if (!reason) return msg.reply('<a:hayigif:787990150331760641> Süre Belirtmedin! Seçeneklerin : 1s/1m/1h/1d/1w')
